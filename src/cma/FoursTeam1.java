 ...
 * @author HOME
 */
public class FoursTeam1 extends javax.swing.JFrame {

    public static  int[] fours1= new int[10];
    
    public static int final_fours1=0;
    
    String team1;
    
    public FoursTeam1(final String title) {
...
public static void main(final String[] args) {
        ...
        final FoursTeam1 demo = new FoursTeam1("FOURS");
        demo.pack();
